...
import { STRING, SOCKET_URL, CHAT_STATUS, PRICE_PEOPLE } from '@constants/Constant'
  ...
  const createOrder = async () => {
    ...
    try {
      const payload = {
        ...
        customer_phone: userInfo?.user_name || '',
        customer_address: userInfo?.address,
        service_id: Number(params?.id) || '',
        checkin_at: moment(checkin_at, 'DD/MM/YYYY').format('YYYY/MM/DD') || '',
        checkin_out: moment(checkout_at, 'DD/MM/YYYY').format('YYYY/MM/DD') || '',
        adult: amountAdults,
        children: amountChildren,
        amount_people: amountAdults + amountChildren,
        note: note || '',
        price: PRICE_PEOPLE.ADULT * amountAdults + PRICE_PEOPLE.CHILDREN * amountChildren,
      }
