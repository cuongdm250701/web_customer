                      ...
                      <ui>
                        <li className="mb-2" style={{ display: 'flex', alignItems: 'center' }}>
                          ...
                          <span className="ml-2">
                            ...
                            <a href="tel:0922227384" className="link-footer">
                              0922227384
                            </a>
                          </span>
                        </li>
                        ...
                        <li className="mb-2" style={{ display: 'flex', alignItems: 'center' }}>
                          ...
                          <span className="ml-2">
                            ...
                            <a href="mailto:test@gmail.com" className="link-footer" target="_blank">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6 footer_element">
                    ...
                    <div className="about-me_list">
                      <ui>
                        ...
                        <li className="about-item">
                          <a href="https://www.facebook.com" target="_blank" className="link-footer">
                            Facebook
                          </a>
                        </li>

                        <li className="about-item">
                          <a href="mailto:test@gmail.com" target="_blank" className="link-footer">
                            ohotour_test@gmail.com
                          </a>
                        </li>
                      </ui>
